...
describe('zipfile', function() {
	it('should be under 300kb', function() {

		var zip = fs.statSync('160x600.zip');
		var fileSizeInKB = zip['size']/1000;
		expect(fileSizeInKB).not.toBeGreaterThan(300, '\nZip size is ' + fileSizeInKB + 'kb, it should be less than 300kb');
	});
});
...
describe('static image', function() {
	it('should match dimensions of the creative', function() {
		...
		var dimensions = imageSize('160x600.jpg');
